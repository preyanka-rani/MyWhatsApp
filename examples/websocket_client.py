"""
Example WebSocket client for testing real-time features.
"""
...
async def test_multiple_events(token: str, conversation_id: str):
    ...
    async with websockets.connect(uri) as websocket:
        ...
        print("\n3️⃣ Testing message read receipt...")
        ...
        print("\n4️⃣ Listening for events for 10 seconds...")
